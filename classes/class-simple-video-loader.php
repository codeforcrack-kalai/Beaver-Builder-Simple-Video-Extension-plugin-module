...
class FL_Simple_Video_Loader {
	...
	static public function load_modules() {
		require_once FL_MODULE_SIMPLE_VIDEO_DIR . 'modules/simple-video/simple-video.php';
	...
	static public function register_fields( $fields ) {
		$fields['my-custom-field'] = FL_MODULE_SIMPLE_VIDEO_DIR . 'fields/my-custom-field.php';
		return $fields;
	}
	...
	static public function enqueue_field_assets() {
		...
		wp_enqueue_style( 'my-custom-fields', FL_MODULE_SIMPLE_VIDEO_URL . 'assets/css/fields.css', array(), '' );
		wp_enqueue_script( 'my-custom-fields', FL_MODULE_SIMPLE_VIDEO_URL	 . 'assets/js/fields.js', array(), '', true );
	}
}

FL_Simple_Video_Loader::init();